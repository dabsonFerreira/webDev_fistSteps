    ...
    <div class = "page-product">
        <div class="columns is-multiline">
            ...
            <div class="column is-3">
                ...
                <p><strong>Preço: R${{  product.price - controle }}</strong></p><!--o controle n funciona aki why??-->
                ...
                <div class="navbar-item">
                    ...
                    <template v-else>
                        <div class="field has-addons mt-6">
                            <router-link to="/log-in" class="button is-danger">Entre para comprar</router-link>
                        </div>
                    </template>
            ...
            /*   console.log('this.product')
                ...
                if(quantidade<=quantidadeBD){
                    const item = {
                        ...
                        quantity: quantidade //era this.quantity
                    } 
                    console.log("item")
                    console.log(item)
                ...
                toast({
                        message: 'Agora não poderemos fornecer a você essa explêndida experiência.',
                        type: 'is-danger',
                        dismissible: true,
                        pauseOnHover: true,
                        duration: 2000,
