            ...
            <div class="column is-12 box">
                ...
                <div class="columns is-multiline">
                    ...
                    <div class="column is-12 box">
                        ...
                        <div class="field">
                            <label>Quanto vale essa experiência?*</label>
                            <div class="control">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="file"><!--@change="onFileSelected" não sei se é pra usar isso-->                                
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            /* onUpload(){
                axios.post('')
            }, *///acredito que eu possa mandar o arquivo para o backend pelo post abaixo 
